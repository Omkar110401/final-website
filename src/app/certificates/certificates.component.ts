...
certificates: Certificate[] = [
    ...
    },
    {
      ...
      photo: '../assets/images/nptel.jpg',
      date: '01-05-2022',
      description: 'NPTEL Certificate demostrating ability to design, develop and analyze algorithms and there complexities.',
    ...
    },
    {
      ...
      date: '23-08-2022',
      description: 'Presented a paper on placement prediction using machine learning in a IEEE conference.',
    ...
    },
    {
      ...
      date: '05-10-2020',
      description: 'Submitted a project on placement prediction using machine learning in a project competetion.',
    ...
    {
      name: 'Chess Competetion',
      category: 'sports',
      photo: '../assets/images/ycce.png',
      date: '01-09-2022',
      description: 'Participated in Chess competetion in national fest organized by YCCE.',
    ...
    },
    {
      ...
      date: '24-10-2021',
      description: 'Attended a 15 days Workshop by Barclays on personality development.',
    ...
    {
      name: 'IEEE Worshop (Placement Training) ',
      category: 'workshop',
    ...
    {
      name: 'CSI Coding Competetion',
      category: 'misc',
      photo: '../assets/images/csi.png',
      date: '10-10-2020',
      description: 'Participated in coding and technical competetion under CSI.',
    ...
    },
    {
      ...
      date: '01-08-2022',
      description: 'Completed a industrial technical training program at Persistent Systems.',
    ...
    },
    {
      ...
      photo: '../assets/images/ksi.png',
      date: '15-11-2020',
      description: 'Completed a training program at Knowledge Solutions India along with a contribution to project competetion.',
  ...
  if (selectedValue === 'all') {
    ...
    this.filteredCertificates = this.certificates.filter(cert => cert.category === selectedValue);
  }
}
}
